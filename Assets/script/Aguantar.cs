...
public class Aguantar : MonoBehaviour
{
    ...
    private float finalSaturation = -100f;   // Saturación final
    private float finalVignette = 1f;       // Intensidad final de la viñeta

    private float countdownTime = 20f;   // Tiempo total del contador (en segundos)
    private float shakeTimer;             // Tiempo restante para la sacudida de la cámara
    ...
    {
        // Aplicar la sacudida a la cámara con una intensidad variable
